...
@section('title', 'Markedia - Форум :: ' .  $category->title)
                            ...
                            <div class="blog-custom-build">
                                ...
                                <div class="blog-box wow fadeIn">
                                    <div class="post-media">
                                        <a href="{{ route('homes.single', ['slug' => $post->slug]) }}" title="">
                                    ...
                                    <div class="blog-meta big-meta text-center">
                                        ...
                                        <h4><a href="{{ route('homes.single', ['slug' => $post->slug]) }}" title="">{{ $post->title }}</a></h4>
