          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                ...
                <p><i class="far fa-circle nav-icon"></i>Список категорий</p>
                </a>
              </li>
              <li class="nav-item">
              <a href="{{route('categories.create')}}" class="nav-link">
                
                <p><i class="far fa-circle nav-icon"></i>Новая категория</p>
                </a>
              </li>
            </ul>
          </li>
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                ...
                <p><i class="far fa-circle nav-icon"></i>Список тегов</p>
                </a>
              </li>
              <li class="nav-item">
              <a href="{{route('tags.create')}}" class="nav-link">
                
                <p><i class="far fa-circle nav-icon"></i>Новый тег</p>
                </a>
              </li>
            </ul>
          </li>
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                ...
                <p><i class="far fa-circle nav-icon"></i>Список статей</p>
                </a>
              </li>
              <li class="nav-item">
              <a href="{{route('posts.create')}}" class="nav-link">
                
                <p><i class="far fa-circle nav-icon"></i>Новая статья</p>
                </a>
              </li>
            </ul>
          </li>
...
<!-- newlara\public\assets\admin\js\bs-custom-file-input.min.js -->
<script src="{{ asset('public\assets\admin\js\bs-custom-file-input.min.js') }}"></script>
    ...
    ClassicEditor
        .create( document.querySelector( '#content' ), {
				...
				.catch( error => {
					...
					console.warn( 'Build id: adgzlhnjn028-hte4ku18nuxa' );
					console.error( error );
				} );
    ...
    ClassicEditor
        .create( document.querySelector( '#description' ), {
          ...
          alignment: {
            ...
            toolbar: [ 'heading', '|', 'bold', 'italic', '|', 'undo', 'alignment', 'redo' ]
        } )
